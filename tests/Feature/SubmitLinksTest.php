...
{
    use RefreshDatabase; //makes sure each test has a new DB to give each test a 'new' DB environment with all migrations
    /**
    ...
    function link_is_not_created_with_an_invalid_url() {
        $this->withoutExceptionHandling(); //disables the form validation
    ...
    function max_length_fails_when_too_long() {
        ...
        $title = str_repeat('a', 256); //creates a 256 long string
